...
Open `docs/index.html` in VS Code and start Live Server from that file. This folder is ready to use as the GitHub Pages `/docs` publishing source.

## File Structure

This archive version is plain HTML, CSS, and JavaScript. There is no TypeScript, Sass, package install, or build step for `docs`.

- `index.html` is the home page
- `pages/` contains non-home route folders like `pages/about/index.html`, `pages/projects/index.html`, and `pages/contact/index.html`
- `styles/main.css` contains the compiled site CSS
- `scripts/` contains the browser JavaScript and site config
- `public/` contains the static assets needed by this GitHub Pages build
- GitHub Pages serves clean URLs through folder indexes, for example `/pages/about/` maps to `pages/about/index.html`
