export const siteConfig = {
    ...
    nav: [
        ...
        { id: `about`, label: `About`, href: `./pages/about/`, icon: `fa-solid fa-anchor` },
        { id: `projects`, label: `Projects`, href: `./pages/projects/`, icon: `fa-solid fa-diagram-project` },
        { id: `services`, label: `Services`, href: `./pages/services/`, icon: `fa-solid fa-screwdriver-wrench` },
        { id: `features`, label: `Features`, href: `./pages/features/`, icon: `fa-solid fa-list-check` },
        { id: `store`, label: `Store`, href: `./pages/store/`, icon: `fa-solid fa-store` },
        { id: `gallery`, label: `Gallery`, href: `./pages/gallery/`, icon: `fa-solid fa-images` },
        { id: `contact`, label: `Contact`, href: `./pages/contact/`, icon: `fa-solid fa-paper-plane` }
    ],
    pages: {
        home: {
            eyebrow: `Piratechs`,
    ...
    stats: [
        ...
        { label: `In Efficiency`, value: `Focus`, text: `Performant Applications to Improve Productivity` },
        { label: `Modernized`, value: `Technologies`, text: `The Most Popular Technologies & Frameworks` }
    ],
    filters: [`Featured`, `All`, `App`, `E-Commerce`, `PWA`, `PHP / WordPress`, `Game`, `Website`],
    projects: [
        {
            type: `PWA`,
            status: `Live`,
        ...
        },
        {
            ...
            summary: `Sanctuary is a game about preventing forest fires, won 2nd place in the 2020 Global Game Jam, and is built with C# and Unity.`,
        },
    ],
    services: [
