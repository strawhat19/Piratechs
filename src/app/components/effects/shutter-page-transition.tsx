...
export default function ShutterPageTransition({
  children,
  slanted = true,
  duration = 0.24,
  showSpinner = false,
  ...
  const restartLoaderAnimation = (element: HTMLElement | null) => {
    if (!element) return;
    element.classList.add(loaderResetClass);
    void element.offsetWidth;
    element.classList.remove(loaderResetClass);
  };
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    restartLoaderAnimation(loaderRef.current);
  ...
  return (
    ...
    >
      <div ref={gridRef} className={`pageTransitionRoot pageTransitionShutter shutterBlindsEffect
          ...
          <div ref={loaderRef} className={`pageTransitionLoader`}>
            ...
            <div className={`pageTransitionLoaderInner`}>
              <Image
                ...
                width={500}
                height={177}
                className={`pageTransitionLoaderImage`}
