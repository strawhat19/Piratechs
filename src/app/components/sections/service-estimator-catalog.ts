...
export const serviceCards = [
  ...
  { id: 'writing', label: 'Writing // Articles', tab: 'Writing', icon: 'fa-pen-nib', description: 'Explain your offer clearly with website copy, useful articles, and brand stories.', price: 50 },
  { id: 'ai', label: 'AI // Drones', tab: 'AI // Drones', icon: 'fa-robot', description: 'Automate customer support, connect workflows, and turn aerial data into insight.', price: 200 },
...
export const creativeOptions: Record<CreativeServiceId, readonly ServiceOption[]> = {
  ai: [
    { id: 'ai-chatbot', label: 'AI Chatbot', price: 200 },
    { id: 'automations', label: 'Automations', price: 200 },
  ...
  writing: [
    { id: 'content', label: 'Content Writing', price: 150 },
...
export const buildFeatures = [
  ...
  { id: 'maintenance', label: 'Launch Support', price: 25 },
  { id: 'content', label: 'Content Writing', price: 150 },
  { id: 'music', label: 'Music Integration', price: 50 },
  { id: 'haptics', label: 'Haptic Feedback', price: 75 },
  { id: 'automations', label: 'Automations', price: 200 },
  { id: 'api-server', label: 'API // Server', price: 250 },
  { id: 'functions', label: 'Cloud Functions', price: 200 },
  ...
  { id: 'dashboard', label: 'Custom Dashboard', price: 250 },
  { id: 'announcements', label: 'Announcements', price: 25 },
  { id: 'international', label: 'International', price: 200 },
  { id: 'accessibility', label: 'Accessibility', price: 100 },
  { id: 'pwa', label: 'PWA - Progressive Web App', price: 150 },
  ...
  { id: 'storage', label: 'File Storage // User Uploads', price: 150 },
  ...
  { id: 'cms-database', label: 'CMS // Database Management', price: 200 },
  ...
  { id: 'customer-order-tracking', label: 'Customer // Order Tracking', price: 200 },
  { id: 'news-letter', label: 'News Letter // Mailing List // RSS Feed', price: 100 },
  { id: 'multiplayer', label: 'Multiplayer // Shared Sessions for Users', price: 450 },
  { id: 'notifications', label: 'Push Notifications or Message Notifications', price: 150 },
  { id: 'auth', label: 'Sign In + Sign Up w/ Google + User Profiles + Roles // Permissions', price: 300 },
  { id: 'ecommerce', label: 'E-Commerce + Products + Cart + Subscriptions + Payments', price: 450, multiplier: 1, multiplier_label: `Product // Service Variant`, },
] as const;
